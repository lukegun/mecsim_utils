...
def mecsim_current(structmodel):
    ...
    MECSettings,Numberin, Reacpara,reacMech,Capaci, Diffvalues, ACSignal, EModown, Currenttot, Ecustom,Tcustom, Error_Code = mecsimclass.transform()

    # Run the MECSIM function
    mecsim_fortran(MECSettings,Numberin,Reacpara,reacMech,Capaci,Diffvalues,ACSignal,EModown,Ecustom,Tcustom,Currenttot, Error_Code)
...
def primaryharmoniccalc(Currenttot, ACfreq, bandwidtharray, std=0.1,windowfunc=True, HilbertTran=True):
    """
