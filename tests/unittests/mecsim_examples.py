...
class example_ftacvEE_ox(validation_setup):
    ...
    # TODO figure out how to make this dynamic mainly so we can duplicate this over the MECSIM unit tests
    inp_file: list[str] = field(
        default_factory=lambda: ['294.75', '500', '-1.2', '1.2', '1', '0.1e0', '18', '0', '1', '1', '1', '0', 
                                 '4000', '0.10', '10.0', '0.005e0', '25.6e0', '0', '0', '2', '0.0', '0.0', '0.50', '-0.50', '1', '0.07854', 
                                 '1.0e0', '1.0e-4', '0.50e0', '0.001e0', '0.10e0', '100.0', '1.0e-1', '1.0e2', '1.0e-5', '1', '80.0e0, 27.5e0', 
                                 '3', '1.0e-6, 5.8e-06, 0', '0.0e0, 5.8e-06, 0', '0.0e0, 5.8e-06, 0', '4', '0', '0.0e0',
                                  '0.0e0', '0.0e0', '0.0e0', '0.0e0', '0,1,-1, 0,0, 0, -0.4, 0.01, 5.0e-01', '0,0,1, -1,0, 0, 0.4, 0.01, 5.0e-01']
        )
    testing_use: str = "This covers a generic EE oxidation case with somewhat high resistance and a quasireversible electrode kinetics"
    AC_case: bool = True
    id: str = "ox_E-E."
    ft_threshold: float = 1.15
    flattern_percentage: float = 0.025
    ...
    # how to fix this
    harmdic: dict = field(
        default_factory=lambda: {0: {'0': (1.7042347498468427e-05, 11282)}, 1: {'1': (5.214691615952667e-05, 5535), '2': (7.716096952996453e-06, 5010),
                                '3': (1.1198515151328813e-06, 10897), '4': (2.9768960277541515e-07, 4952), 
...
class example_ftacvEE_red(validation_setup):
    ...
    # TODO figure out how to make this dynamic mainly so we can duplicate this over the MECSIM unit tests
    inp_file: list[str] = field(
        default_factory=lambda: ['294.75', '50', '1.2', '-1.2', '1', '0.1e0', '18', '0', '1', '1', '1', '0', '4000', '0.10', '10.0', '0.005e0', '25.6e0', '0', '0', '2', '0.0', '0.0', '0.50', '-0.50', '1', '0.07854', '1.0e0', '1.0e-4', '0.50e0', '0.001e0', '0.10e0', '100.0', '1.0e-1', '1.0e2', '1.0e-5', '1', '80.0e0, 27.5e0', '3', '1.0e-6, 5.8e-06, 0', '0.0e0, 5.8e-06, 0', '0.0e0, 5.8e-06, 0', '4', '0', '0.0e0', '0.0e0', '0.0e0', '0.0e0', '0.0e0', '0,-1,1, 0,0, 0, 0.4, 0.01, 7.0e-01', '0,0,-1, 1,0, 0, -0.4, 0.01, 7.0e-01']
    )
    testing_use: str = "This covers a generic EE reduction case with minimal resistance, quasireversible and mild asymetry of electrod kinetics"
    AC_case: bool = True
    id: str = "red_E-E."
    ft_threshold: float = 1.15
    flattern_percentage: float = 0.025
    ...
    # how to fix this
    harmdic: dict = field(
        default_factory=lambda: {0: {'0': (1.2669945344821087e-05, 27663)}, 
                                 1: {'1': (7.059248958627867e-05, 10962), '2': (1.3168849554644293e-05, 10559), 
                                 '3': (4.119084366382263e-06, 10955), '4': (8.38054608206708e-07, 5178),
                                   '5': (2.385874236938491e-07, 5489), '6': (5.205952386445564e-08, 11225)}}
    )
    N_harms: int = 7
    shape: int = 262144
