...
# validation of the MECSIM validation
@dataclass
class example_ftacvEC1_ox(validation_setup):
...
# validation of the MECSIM validation
@dataclass
class example_ftacvEC1_red(validation_setup):
...
# validation of the MECSIM validation
@dataclass
class example_ftacvEC2_ox(validation_setup):
...
# validation of the MECSIM validation
@dataclass
class example_ftacvEC2_red(validation_setup):
